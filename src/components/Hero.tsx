            ...
            <div className="flex flex-col h-[550px]">
              ...
              <div className="flex flex-1 overflow-hidden">
                ...
                <div className="w-16 border-r border-white/5 flex flex-col items-center py-8 gap-8 bg-base-950/50">
                  <span className="material-symbols-outlined text-primary shadow-glow-primary">forum</span>
                  <span className="material-symbols-outlined text-white/20">shopping_cart</span>
                  <span className="material-symbols-outlined text-white/20">analytics</span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                       <div className="bg-base-950/80 p-4 rounded-2xl border border-white/5">
                          <p className="text-[10px] uppercase text-on-surface-variant mb-2">Active Conversations</p>
                          <div className="flex justify-between items-end">
                            <span className="text-2xl font-bold text-white">128</span>
                            <span className="text-emerald-400 text-xs flex items-center gap-1"><span className="material-symbols-outlined text-xs">trending_up</span>12%</span>
                          </div>
                       </div>
                       <div className="bg-base-950/80 p-4 rounded-2xl border border-white/5">
                          <p className="text-[10px] uppercase text-on-surface-variant mb-2">Sales Conversion</p>
                          <div className="flex justify-between items-end">
                            <span className="text-2xl font-bold text-white">24.5%</span>
                            <span className="text-primary text-xs">High</span>
                          </div>
                       </div>
                    </div>
                  </div>
